...
class TestPoolFlow:
    ...
    async def test_pool_ingest_creates_pending_items(self, client, db_conn):
        ...
        pipeline_resp = await client.post("/v1/pipelines", json={
        ...
        # Ingest items
        resp = await client.post("/v1/pool/ingest", json={
    ...
    async def test_pool_duplicate_rejected(self, client, db_conn):
        ...
        # First ingest
        resp1 = await client.post("/v1/pool/ingest", json={
            "pipeline_id": pipeline_id,
        ...
        resp2 = await client.post("/v1/pool/ingest", json={
            "pipeline_id": pipeline_id,
    ...
    async def test_pool_single_ingest(self, client, db_conn):
        ...
        resp = await client.post("/v1/pool/ingest/single", json={
            "pipeline_id": pipeline_id,
